...
class SimpleMap extends Component {
      ...
      infoWindow = (
        ...
        >
          ...
          <div style={{ backgroundColor: "pink", opacity: 1, padding: 3 }}>
            <p>
              <b>{this.state.myInfoWindow?.name}</b>
            </p>
            <p>
              {" "}
              {
                <p>
                  <img src={this.state.myInfoWindow?.imgSrc} />
                </p>
              }
            </p>

            <p>
              <a href={this.state.myInfoWindow?.imgSrc}>Learn More</a>
            </p>
  ...
  onClickChange = (locPosition) => {
    ...
    console.log(
      "my new center is" + this.state.center.lat + " " + this.state.center.lng
    );
  };
}
