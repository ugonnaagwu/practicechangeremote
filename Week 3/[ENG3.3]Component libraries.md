...
- 60 minutes - Session:
  ...
  - 5 minutes - Styling the FluentUI components with the Theme Designer
  - 10 minutes – using components inside your components

## Resources

- [Link to the sample app for this lesson.](https://github.com/tnt-summer-academy/Samples/tree/main/Week_3/component-library-fluent)
...
For a component library you're going to want to focus on how to find, figure out, and add components to your program. Let's go through an example: Adding a DatePicker to your App.js, and responding when the user picks a date.
...
For this example we're going to use a [Stack](https://developer.microsoft.com/en-us/fluentui#/controls/web/stack) to show a vertical list of [Persona](https://developer.microsoft.com/en-us/fluentui#/controls/web/persona)s.

Note that this time we're going to create our own, custom component (the `PersonaWithClickCounter`)

The custom component also has event handling (via the onClick handler).
